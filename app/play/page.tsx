...
import { IsoFrame } from "@/components/game/IsoFrame";
...
export default function PlayPage() {
  return (
    <main className="min-h-screen bg-parchment text-ink overflow-x-hidden">
      <header className="relative z-10 max-w-3xl mx-auto flex items-center justify-between px-6 pt-8">
        <Link
          href="/"
